namespace lightAsp
{
    ...
    public class FrmMain : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.contextMenuStrip.Size = new System.Drawing.Size(166, 148);
            // 
            // itmOpen
            // 
            ...
            this.itmOpen.Image = ((System.Drawing.Image)(resources.GetObject("itmOpen.Image")));
            this.itmOpen.Name = "itmOpen";
            this.itmOpen.Size = new System.Drawing.Size(165, 22);
            ...
            this.itmSep00.Size = new System.Drawing.Size(162, 6);
            // 
            // itmEditWebConfig
            // 
            this.itmEditWebConfig.Image = ((System.Drawing.Image)(resources.GetObject("itmEditWebConfig.Image")));
            this.itmEditWebConfig.Name = "itmEditWebConfig";
            this.itmEditWebConfig.Size = new System.Drawing.Size(165, 22);
            ...
            this.itmSettings.Size = new System.Drawing.Size(165, 22);
            this.itmSettings.Text = "Configuration";
            this.itmSettings.Click += new System.EventHandler(this.itmSettings_Click);
            // 
            // itmAbout
            // 
            this.itmAbout.Image = ((System.Drawing.Image)(resources.GetObject("itmAbout.Image")));
            this.itmAbout.Name = "itmAbout";
            this.itmAbout.Size = new System.Drawing.Size(165, 22);
            ...
            this.itmSep01.Size = new System.Drawing.Size(162, 6);
            // 
            // itmStartStop
            // 
            this.itmStartStop.Image = ((System.Drawing.Image)(resources.GetObject("itmStartStop.Image")));
            this.itmStartStop.Name = "itmStartStop";
            this.itmStartStop.Size = new System.Drawing.Size(165, 22);
            this.itmStartStop.Text = "Start Server";
            this.itmStartStop.Click += new System.EventHandler(this.itmStartStop_Click);
            // 
            // itmShutdown
            // 
            this.itmShutdown.Image = ((System.Drawing.Image)(resources.GetObject("itmShutdown.Image")));
            this.itmShutdown.Name = "itmShutdown";
            this.itmShutdown.Size = new System.Drawing.Size(165, 22);
        ...
        {
            if (lightAsp.Settings.GetSetting("PhysicalDirectory") != null)
            {
                this.txtPhisicalDirectory.Text = lightAsp.Settings.GetSetting("PhysicalDirectory");
            }
            if (lightAsp.Settings.GetSetting("VirtualDirectory") != null)
            {
                this.txtVirtualDirectory.Text = lightAsp.Settings.GetSetting("VirtualDirectory");
            }
            if (lightAsp.Settings.GetSetting("Port") != null)
            {
                this.txtPort.Text = lightAsp.Settings.GetSetting("Port");
            }
            if (lightAsp.Settings.GetSetting("DisallowRemoteConnections") != null)
            {
                this.chkDisallowRemoteConnections.Checked = bool.Parse(lightAsp.Settings.GetSetting("DisallowRemoteConnections"));
            }
        ...
        private void Start()
        {
            ...
            if ((this.txtVirtualDirectory.Text.Length != 0) && this.txtVirtualDirectory.Text.StartsWith("/"))
            {
                ...
                catch (Exception exception)
                {
                    ...
                    //{
                    //    GacUtil.Install(Application.StartupPath + @"\WebServer.dll");
        ...
        //Label_022F:
            ...
            //this.itmStartStop.Image = Resources.Stop;
            this.itmOpen.Enabled = true;
            lightAsp.Settings.SetSetting("PhysicalDirectory", text);
            lightAsp.Settings.SetSetting("VirtualDirectory", this.txtVirtualDirectory.Text);
            lightAsp.Settings.SetSetting("Port", this.txtPort.Text);
            lightAsp.Settings.SetSetting("DisallowRemoteConnections", this.chkDisallowRemoteConnections.Checked.ToString());
            lightAsp.Settings.Save();
        }
        ...
        private void Stop()
        {
            if (this.server != null)
            {
                ...
                //this.itmStartStop.Image = Resources.Start;
                this.itmOpen.Enabled = false;
                //this.notifyIcon.Icon = Resources.WikiSmallGray;
            }
        }
