namespace lightAsp
{
    ...
    public static class Settings
    {
        ...
        private static string SettingsFile = System.Windows.Forms.Application.StartupPath + @"\Settings.txt";//(Environment.GetFolderPath(Environment.SpecialFolder.CommonApplicationData) + @"\ScrewTurn Software\ASP.net Light Server\Settings.txt");
